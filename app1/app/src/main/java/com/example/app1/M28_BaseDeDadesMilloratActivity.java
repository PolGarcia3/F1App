...
public class M28_BaseDeDadesMilloratActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Contentvalues es una clase que empaqueta información
        ContentValues valors = new ContentValues();
        valors.put(AlumneContract.TaulaAlumne.COLUMNA_CODI, "1237");
        valors.put(AlumneContract.TaulaAlumne.COLUMNA_NOM, "Pol");
        valors.put(AlumneContract.TaulaAlumne.COLUMNA_NOTA, 4);
        ...
        // Cursor es una especie de apuntador que va iterando por cada tabla, ya que la base de datos no sabe en que lenguaje estamos programando
        Cursor c = db.query(
